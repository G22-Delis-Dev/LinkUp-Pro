        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BattleshipBoards_Users_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BattleshipAttacks_BattleshipBoards_BoardId",
                        column: x => x.BoardId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BattleshipShips_BattleshipBoards_BoardId",
                        column: x => x.BoardId,
                        principalTable: "BattleshipBoards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BattleshipAttacks_BoardId",
                table: "BattleshipAttacks",
                column: "BoardId");

            migrationBuilder.CreateIndex(
                name: "IX_BattleshipBoards_GameId_PlayerId",
                table: "BattleshipBoards",
                columns: new[] { "GameId", "PlayerId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BattleshipBoards_PlayerId",
                table: "BattleshipBoards",
                column: "PlayerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BattleshipShips_BoardId",
                table: "BattleshipShips",
                column: "BoardId");

            migrationBuilder.CreateIndex(
                name: "IX_BattleshipShips_BoardId_Size",
                table: "BattleshipShips",
                columns: new[] { "BoardId", "Size" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserTokens_UserId_Type_IsUsed",
                table: "UserTokens",
